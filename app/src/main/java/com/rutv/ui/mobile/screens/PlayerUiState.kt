...
data class PlayerUiState(
    ...
    val channelEpgListRatioPercent: Int,
    val listPanelEdgeInsetDp: Int,
    val listPanelVerticalInsetDp: Int,
    val channelPreviewSizePreset: Int,
...
data class PlayerUiActions(
    ...
    val onSwitchChannelRelative: (Int) -> Unit,
    ...
    val onSeekProgramProgressTo: (Long) -> Unit,
...
fun rememberPlayerUiState(viewState: MainViewState): PlayerUiState {
    return remember(viewState) {
        ...
        PlayerUiState(
            ...
            channelEpgListRatioPercent = viewState.channelEpgListRatioPercent,
            listPanelEdgeInsetDp = viewState.listPanelEdgeInsetDp,
            listPanelVerticalInsetDp = viewState.listPanelVerticalInsetDp,
            channelPreviewSizePreset = viewState.channelPreviewSizePreset,
